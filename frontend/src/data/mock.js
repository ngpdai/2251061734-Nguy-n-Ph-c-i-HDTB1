export const portfolioData = {
  en: {
    ...
    title: "Business Analyst Aspirant | Operations & Customer Experience Professional",
    bio: "Final year IT student with a strong programming foundation and diverse operational experience. Passionate about transforming business requirements into actionable insights and technical solutions through data analysis and AI/ML integration.",
    
    about: {
      title: "About Me",
      content: "I am a dedicated professional with a unique blend of hands-on operational experience and strong technical foundation. My journey has taken me through customer experience management at WinCommerce's WinMart+, quality operations at Abby & Savor, and independent consulting projects. Currently pursuing my IT degree at Thuyloi University, I am eager to leverage my practical business knowledge and technical skills to transition into a Business Analyst role where I can bridge the gap between business needs and technology solutions.",
      goals: [
        "Learn and work with experienced AI Engineers",
        "Participate in real-world AI and data analysis projects",
        "Transform business challenges into data-driven solutions",
        "Contribute to organizational growth through analytical insights"
      ]
    },
      ...
      jobs: [
        {
          ...
          details: [
            ...
            "Operated according to modern retail system standards, coordinating closely with internal teams",
        ...
        },
        {
          ...
          details: [
            ...
            "Collaborated effectively in high-paced production environments",
        ...
        },
        {
          id: 3,
          company: "Independent",
          position: "Freelance Account Growth Consultant",
          period: "2021 - Present",
          summary: "Delivered consulting and optimization projects based on specific client KPIs and requirements.",
          details: [
            "Deployed consulting and account optimization projects tailored to specific client KPIs and requirements",
            "Managed multiple independent projects simultaneously, ensuring timeline and quality commitments",
      ...
      institutions: [
        {
          ...
          summary: "Comprehensive IT education with focus on AI, data structures, and business applications.",
          courses: [
            "Artificial Intelligence - Machine learning algorithms, neural networks, and AI applications",
            "Data Structures and Algorithms - Advanced problem-solving and algorithmic thinking",
            "Databases - Database design, SQL, and data management systems",
            "Object-Oriented Programming - Software design patterns and development methodologies",
            "Computer Graphics - Visual computing and interface design principles"
          ],
          achievements: [
    ...
    contact: {
      title: "Get In Touch",
      subtitle: "I'm open to Business Analyst internship opportunities and professional collaborations.",
      info: {
        email: "Isimp920@gmail.com",
        phone: "0825091067",
        location: "Hanoi, Vietnam",
        availability: "Flexible schedule, minimum 20 hours/week"
      },
      social: [
        {
          platform: "Facebook",
          url: "https://www.facebook.com/profile.php?id=61555499445522",
          icon: "facebook"
        },
        {
          platform: "YouTube",
          url: "https://www.youtube.com/channel/UCaCDeMgjK44KAqiGvaJiIgA",
          icon: "youtube"
        }
      ]
    }
  ...
  vi: {
    name: "Nguyễn Phúc Đại",
    title: "Ứng Viên Business Analyst | Chuyên Viên Vận Hành & Trải Nghiệm Khách Hàng",
    bio: "Sinh viên IT năm cuối với nền tảng lập trình vững chắc và kinh nghiệm vận hành đa dạng. Đam mê chuyển đổi yêu cầu kinh doanh thành giải pháp kỹ thuật và thông tin chi tiết thông qua phân tích dữ liệu và tích hợp AI/ML.",
    
    about: {
      title: "Về Tôi",
      content: "Tôi là một chuyên gia tận tâm với sự kết hợp độc đáo giữa kinh nghiệm vận hành thực tế và nền tảng kỹ thuật vững chắc. Hành trình của tôi đã đưa tôi qua quản lý trải nghiệm khách hàng tại WinMart+ của WinCommerce, vận hành chất lượng tại Abby & Savor, và các dự án tư vấn độc lập. Hiện đang theo học ngành CNTT tại Đại học Thủy Lợi, tôi mong muốn tận dụng kiến thức kinh doanh thực tế và kỹ năng kỹ thuật để chuyển sang vai trò Business Analyst, nơi tôi có thể kết nối giữa nhu cầu kinh doanh và giải pháp công nghệ.",
      goals: [
        "Học hỏi và làm việc cùng các AI Engineer có kinh nghiệm",
        "Tham gia các dự án AI và phân tích dữ liệu thực tế",
        "Chuyển đổi thách thức kinh doanh thành giải pháp dựa trên dữ liệu",
        "Đóng góp vào sự phát triển tổ chức thông qua phân tích chuyên sâu"
      ]
    },
      ...
      jobs: [
        {
          ...
          details: [
            ...
            "Vận hành theo quy trình chuẩn của hệ thống bán lẻ hiện đại, phối hợp chặt chẽ với đội ngũ nội bộ",
        ...
        },
        {
          ...
          details: [
            ...
            "Phối hợp hiệu quả trong môi trường sản xuất có nhịp độ cao",
        ...
        },
        {
          id: 3,
          company: "Độc Lập",
          position: "Freelance - Chuyên Viên Tư Vấn Phát Triển Tài Khoản",
          period: "2021 - Hiện tại",
          summary: "Triển khai các dự án tư vấn và tối ưu hóa dựa trên KPI cụ thể của khách hàng.",
          details: [
            "Triển khai các dự án tư vấn và tối ưu hóa tài khoản theo yêu cầu và KPI cụ thể từ khách hàng",
            "Quản lý đồng thời nhiều dự án độc lập, đảm bảo tiến độ và chất lượng đầu ra theo đúng cam kết",
      ...
      institutions: [
        {
          ...
          summary: "Chương trình đào tạo CNTT toàn diện tập trung vào AI, cấu trúc dữ liệu và ứng dụng kinh doanh.",
          courses: [
            "Trí tuệ nhân tạo - Thuật toán học máy, mạng nơ-ron và ứng dụng AI",
            "Cấu trúc dữ liệu và giải thuật - Tư duy thuật toán và giải quyết vấn đề nâng cao",
            "Cơ sở dữ liệu - Thiết kế cơ sở dữ liệu, SQL và hệ thống quản lý dữ liệu",
            "Lập trình hướng đối tượng - Mẫu thiết kế phần mềm và phương pháp phát triển",
            "Đồ họa máy tính - Nguyên lý tính toán trực quan và thiết kế giao diện"
          ],
          achievements: [
    ...
    contact: {
      title: "Liên Hệ",
      subtitle: "Tôi mở cửa cho các cơ hội thực tập Business Analyst và hợp tác chuyên nghiệp.",
      info: {
        email: "Isimp920@gmail.com",
        phone: "0825091067",
        location: "Hà Nội, Việt Nam",
        availability: "Lịch làm việc linh hoạt, tối thiểu 20 giờ/tuần"
      },
      social: [
        {
          platform: "Facebook",
